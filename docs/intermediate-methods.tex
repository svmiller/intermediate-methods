...
\hypersetup{
  pdftitle={Steve's Methods Guide: A Book on Intermediate Methods That Will Assuredly Have a Better Name When I'm Done With It},
...
{\centering \includegraphics[width=0.8\linewidth]{intermediate-methods_files/figure-latex/nice-fig-1} 
